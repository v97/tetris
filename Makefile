#############################################################################
# Makefile for building: project02
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Oct 12 12:29:19 2016
# Project:  project02.pro
# Template: app
# Command: /usr/local/software/qt4/bin/qmake -o Makefile project02.pro
#############################################################################
...
Makefile: project02.pro  /usr/local/software/qt-4.8.6/mkspecs/linux-g++-64/qmake.conf /usr/local/software/qt-4.8.6/mkspecs/common/unix.conf \
		/usr/local/software/qt-4.8.6/mkspecs/common/linux.conf \
		/usr/local/software/qt-4.8.6/mkspecs/common/gcc-base.conf \
		/usr/local/software/qt-4.8.6/mkspecs/common/gcc-base-unix.conf \
		/usr/local/software/qt-4.8.6/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile project02.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/project021.0.0 || $(MKDIR) .tmp/project021.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/project021.0.0/ && $(COPY_FILE) --parents block.h window.h .tmp/project021.0.0/ && $(COPY_FILE) --parents block.cpp main.cpp window.cpp .tmp/project021.0.0/ && (cd `dirname .tmp/project021.0.0` && $(TAR) project021.0.0.tar project021.0.0 && $(COMPRESS) project021.0.0.tar) && $(MOVE) `dirname .tmp/project021.0.0`/project021.0.0.tar.gz . && $(DEL_FILE) -r .tmp/project021.0.0
...
compiler_moc_header_make_all: moc_block.cpp moc_window.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_block.cpp moc_window.cpp
moc_block.cpp: block.h
	/usr/local/software/qt-4.8.6/bin/moc $(DEFINES) $(INCPATH) block.h -o moc_block.cpp

moc_window.cpp: block.h \
		window.h
